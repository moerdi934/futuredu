...
import { FileJson, Save, X, FileText, Upload, Download, Eye } from 'lucide-react';
...
{`{
  ...
  "passageText": "<p>Isi bacaan...</p>"
              ...
              {showPreview && previewContent && (
                <div className="tw-bg-white tw-border-2 tw-border-orange-300 tw-rounded-lg tw-overflow-hidden">
                  <div className="tw-bg-gradient-to-r tw-from-orange-600 tw-to-red-600 tw-text-white tw-px-4 tw-py-2 tw-flex tw-items-center tw-gap-2">
