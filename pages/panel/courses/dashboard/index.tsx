...
const StudentCourseDashboard = dynamic(
  () => import('./StudentCourseDashboard'),        // ganti dengan path relatifmu
  { ssr: false }
);

const AdminCourseDashboard = dynamic(
  () => import('./AdminCourseDashboard'),          // ganti dengan path relatifmu
  { ssr: false }
);
