// pages/api/userCourse/courses/[courseString].ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    switch (method) {
      case 'GET':
        // GET /api/userCourse/courses/:courseString - Get course detail (optional auth)
        await runMiddleware(req as AuthenticatedRequest, res, optionalAuthenticateJWT);
        await userCourseController.getCourseDetailReadable(req as AuthenticatedRequest, res);
        break;
